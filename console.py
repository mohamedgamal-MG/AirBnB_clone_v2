...
class HBNBConsole(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        elif argl[0] not in HBNBConsole.__classes:
    ...
    def do_all(self, arg):
        ...
        if len(argl) > 0 and argl[0] not in HBNBConsole.__classes:
            print("** class doesn't exist **")
        else:
            objl = []
    ...
    def do_update(self, arg):
        ...
        if argl[0] not in HBNBConsole.__classes:
            print("** class doesn't exist **")
            return False
...
class TestHBNBConsole(unittest.TestCase):
    ...
    def test_count_invalid_class_name(self):
        with patch('sys.stdout', new=self.mock_stdout):
            ...
            self.assertEqual(self.mock_stdout.getvalue().strip(), "0")
    ...
    def test_update_invalid_class_name(self):
        with patch('sys.stdout', new=self.mock_stdout):
            self.console.onecmd("update InvalidClass 123")
            self.assertEqual(self.mock_stdout.getvalue().strip(), "** class doesn't exist **")
